...
*/
void CGame::Draw(float x, float y, LPDIRECT3DTEXTURE9 texture, int left, int top, int right, int bottom, CARGB argb)
{
...
void CGame::InitKeyboard(LPKEYHANDLER handler)
{
	HRESULT
