...
#define OVERLAYBOARD_ITEM_FRAME_X OVERLAYBOARD_PLAYER_HEALTH_ICON_Y+OVERLAYBOARD_ENEMY_HEALTH_SPACING*(SIMON_HEALTH_DEFAULT-1)+HEALTHICON_BBOX_WIDTH*SIMON_HEALTH_DEFAULT+ OVERLAYBOARD_X_SPACING
#define OVERLAYBOARD_ITEM_FRAME_Y OVERLAYBOARD_PLAYER_HEALTH_Y
#define OVERLAYBOARD_HEART_X OVERLAYBOARD_ITEM_FRAME_X + ITEMFRAME_BBOX_WIDTH + OVERLAYBOARD_X_SPACING
